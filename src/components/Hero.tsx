      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-6 text-center md:text-left">
            <Link 
              to="/nearby-matches" 
              className="inline-block px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-sm font-medium text-white hover:bg-white/20 transition-colors"
            >
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 sm:gap-8 pt-10 text-white">
