...
const Hero = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      {/* Wave decoration */}
      <div className="absolute bottom-0 left-0 right-0 leading-[0] border-none outline-none shadow-none -mb-px">
        <svg viewBox="0 0 1440 120" xmlns="http://www.w3.org/2000/svg" className="w-full block border-none outline-none shadow-none" preserveAspectRatio="none" style={{ display: 'block', verticalAlign: 'middle' }}>
