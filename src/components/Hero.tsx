        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-6 text-center md:text-left">
            <div className="inline-block px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-sm font-medium mb-4">
              India's Modern Dating Platform 🇮🇳
            </div>
            
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
              Welcome to <span className="text-accent">VibeLink</span>
            </h1>
            
            <p className="text-lg md:text-xl text-accent-foreground/90 max-w-xl">
              Meet like-minded singles across India—safe, genuine, and designed for meaningful connections. 
            ...
            <div className="flex items-center justify-center md:justify-start gap-8 pt-8 text-sm">
              <div>
                <div className="text-2xl font-bold">100K+</div>
                <div className="text-accent-foreground/80">Active Users</div>
              </div>
              <div className="w-px h-12 bg-white/20" />
              <div>
                <div className="text-2xl font-bold">50K+</div>
                <div className="text-accent-foreground/80">Matches Made</div>
              </div>
              <div className="w-px h-12 bg-white/20" />
              <div>
                <div className="text-2xl font-bold">4.8★</div>
                <div className="text-accent-foreground/80">User Rating</div>
              </div>
            </div>
          </div>
