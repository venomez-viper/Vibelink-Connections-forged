...
import { ArrowRight, ArrowLeft, User, Mail, Lock, MapPin } from "lucide-react";
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-4">
                    <div className="my-4 flex items-center gap-4">
                      ...
                      <span className="text-xs uppercase tracking-widest text-muted-foreground">or sign up with</span>
                      <span className="flex-1 h-px bg-white/10" />
                    </div>
                    <div className="flex gap-3">
                      <button type="button" onClick={handleGoogleSignUp} className="flex-1 flex items-center justify-center py-2.5 rounded-xl border border-white/10 hover:border-primary/50 hover:bg-primary/5 transition-all" aria-label="Sign up with Google">
                        <GoogleIcon />
                      </button>
                      <button type="button" className="flex-1 flex items-center justify-center py-2.5 rounded-xl border border-white/10 hover:border-primary/50 hover:bg-primary/5 transition-all text-muted-foreground hover:text-foreground" aria-label="Sign up with Instagram">
                        <InstagramIcon />
                      </button>
                      <button type="button" className="flex-1 flex items-center justify-center py-2.5 rounded-xl border border-white/10 hover:border-primary/50 hover:bg-primary/5 transition-all text-muted-foreground hover:text-foreground" aria-label="Sign up with Apple">
                        <AppleIcon />
                      </button>
                    </div>
                  </div>
